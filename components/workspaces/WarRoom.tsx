...
// Updated mapping for activations with valid MainMode and SubModule IDs
const OPPORTUNITIES = [
  { label: "Automated Visual Content Engine (Reels/TikTok)", target: { mode: 'MEDIA' as MainMode, mod: 'VIDEO_PRODUCTION' as SubModule } },
  { label: "AI-Powered Booking Agent Integration", target: { mode: 'OUTREACH' as MainMode, mod: 'AI_CONCIERGE' as SubModule } },
  { label: "Digital Twin Virtual Tour", target: { mode: 'DESIGN' as MainMode, mod: 'MOCKUPS_4K' as SubModule } },
  { label: "High-Ticket Retargeting Sequence", target: { mode: 'OUTREACH' as MainMode, mod: 'SEQUENCER' as SubModule } }
];
