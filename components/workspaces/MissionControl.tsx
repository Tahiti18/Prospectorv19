...
export const MissionControl: React.FC<MissionControlProps> = ({ leads, theater, onNavigate }) => {
  ...
  // Updated action modes and IDs to use valid values
  const actions = [
    { id: 'MARKET_DISCOVERY', mode: 'RESEARCH' as MainMode, title: 'LEAD DISCOVERY', desc: 'INITIATE MARKET SCAN', icon: <ControlIcon type="RADAR" />, theme: 'emerald', help: "Start here! Use the radar to scan a specific city and find businesses that match your criteria." },
    { id: 'PROSPECT_DATABASE', mode: 'RESEARCH' as MainMode, title: 'LEAD DATABASE', desc: 'ACCESS RECORDS', icon: <path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20M4 4.5A2.5 2.5 0 0 1 6.5 7H20v10H6.5" />, theme: 'emerald', help: "View your saved list of potential clients. Sort them by score and pick who to contact." },
    { id: 'VIDEO_PRODUCTION', mode: 'MEDIA' as MainMode, title: 'ASSET STUDIO', desc: 'GENERATE CONTENT', icon: <ControlIcon type="ASSET" />, theme: 'emerald', help: "Go to the creative studio to generate custom videos or images to send to your leads." }
  ];
